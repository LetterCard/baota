...
Install_Bt(){
	...
	wget -O panel-7.7.0-crack.zip https://raw.githubusercontent.com/LetterCard/baota/main/panel-7.7.0-crack.zip -T 10
	...
	unzip -o panel-7.7.0-crack.zip -d ${setup_path}/server/ > /dev/null
